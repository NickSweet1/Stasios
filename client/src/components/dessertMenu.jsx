  ...
  return (
    <div name='menu' className='bg-white rounded-xl items-center min-h-screen max-h-3/4 relative mb-4 p-4 mt-[13rem] px-4 max-w-[1500px] mx-auto text-amber-950'>
      ...
      <div className='text-3xl md:text-5xl lg:text-6xl text-center mb-6 relative'>
        ...
        <br />
        <span className="text-[30px] text-amber-800 opacity-50 cursor-pointer"><span className='cursor-pointer'>Sandwiches</span> / <span className="cursor-pointer underline decoration-black">Desserts</span> / <span className="cursor-pointer">Coffees</span></span> {/* Smaller and light grey */}
      </div>
